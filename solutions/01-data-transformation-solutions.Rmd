...
minutes of delay. Then determine what proportion of the total delay minutes each 
destination represents. What three destinations top the list? 
...
[`group_by()`][group_by] `dest`, then [`summarize()`][summarize] to find total 
delay minutes by destination, then [`mutate()`][mutate] to find proportions, and
finally [`arrange()`][arrange] to find the top three. 

This question is based on [5.7.1#4][5.7.1 Exercises] and designed to strengthen 
your ability to calculate a per-group proportion of a total. See 
