...
# The warning message indicates that the second observation has an extra piece of information (or value), and that this extra piece (i.e., "g") was dropped. Setting the `extra` argument to "merge"" rather than "warn", its default, remedies this situation.
