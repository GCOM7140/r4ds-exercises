...
# Multiple observations results in the spread() function not working correctly. Use a keep variable.
...
# Preg must be gathered, values as var names
...
# Second observation has extra information and was removed. Set extra to merge to reverse this.
...
# The remove function dictates if the column will be removed or not. Default is to remove, setting to false would keep the column.
...
# Interesting to see the overall increase over time. Big spike after 2005 for India.
...
# 30 - 35 is the most common by far then decreases steadily.
...
# Same story - around 35 is the peak
