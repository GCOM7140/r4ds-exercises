...
#Preg includes prednant, gender and count
...
#warning message indicates the second row has addtional message "g" outside of the 3 letters in other rows.
...
#the remove argument determines whether or not to remove extra information from the data set. The default is to remove extra infomration
