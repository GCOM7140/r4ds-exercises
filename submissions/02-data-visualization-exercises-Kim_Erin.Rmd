...
# No since the first graph's arguments carry over to the subsequent functions, while the second graph's functions each have the same arguments; it will be the same either way
```
