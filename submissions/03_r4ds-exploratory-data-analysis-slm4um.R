...
#cheaper diamonds sell much more frequently than higher priced diamonds

# Question 2: Which of the 4Cs (carat, cut, clarity, color) is most important for predicting the price of a diamond?
x <- lm(price ~ carat + cut + clarity + color, diamonds)
x$coefficients
...
#higher the number of carats higher the price
