...
# The first graph  only shows an overall relationship is positive between displ and cyl, while the second graph shows more details with medians, outliers, range.
