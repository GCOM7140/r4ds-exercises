#'---
#'title: "R4DS Data Wrangling HMWK #4"
#'Author: Mike Van Slyke
#'Date: 3/28/2019
...
#'The remove argument determines whether the column being parsed is removed or not and setting it to false keeps it in
...
who %>%
  ...
  geom_point() + 
  geom_line()
#' finding out what happened in India in 2007
